export type ArtworkCategory = 'Abstract' | 'Islamic Art' | 'Portraits' | 'Calligraphy' | 'Modern Art';
...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    width: 50,
    height: 50,
    medium: "Mixed Media on Parchment",
    year: 2023,
  ...
  },
  {
    ...
    width: 80,
    height: 60,
    medium: "Textured Paste and Acrylic",
    year: 2023,
